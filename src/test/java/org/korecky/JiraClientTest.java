...
public class JiraClientTest {
    ...
    public void getSprintDetails(String sprintId, Sprint expectedSprint, String responseJson) throws Exception {
    ...
    public void getIssueDetails(String issueKey, Issue expectedIssue, String responseJson) throws Exception {
        String url = "https://your-jira-server.com/rest/api/2/issue/" + issueKey;
        mockResponse(url, responseJson);

        Issue issue = jiraClient.getIssueDetails(issueKey);
        ...
        Assert.assertEquals(issue.getFields().size(), 19);
    }
